...
class Talo:
    def __init__(self, alinkerros, ylinkerros, hissit_lkm):
        self.alinkerros = alinkerros
        self.ylinkerros = ylinkerros
        self.hissit = [Hissi(i) for i in range (1, hissit_lkm + 1)]
    ...
    def palohälytys(self):
        print(f"Palohälytys soi, kaikki hissit siirtyvät alimpaan kerrokseen.")
        for i in self.hissit:
            print(f"Hissi {self.hissit(i) + 1} on menossa alimpaan kerrokseen.")
